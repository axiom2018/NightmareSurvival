...
class ShotgunBullet : public Entities
{
private:
    char m_bullet;
...
public:
    ...
    virtual int GetId() const override { return SHOTGUN_BULLET; }
    ...
    virtual int GetBulletDamage() const override { return SHOTGUN_BULLET_DAMAGE; }
};
