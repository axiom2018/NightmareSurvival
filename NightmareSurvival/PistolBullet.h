...
class PistolBullet : public Entities
{
private:
    const int m_id = 0; // Id's are for the ObjectPool.cpp, when we return a bullet to an object pool, we'll figure out what list to return it to based on the id.
    char m_bullet;
